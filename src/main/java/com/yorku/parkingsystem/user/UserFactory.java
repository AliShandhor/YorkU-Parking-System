...
public class UserFactory {
    ...
    public static User getUser(String clientType, int userID, String firstName, String lastName, String licensePlate) {
        // Check the clientType and return the corresponding user subclass
        if (clientType.equalsIgnoreCase("STUDENT")) {
            return new Student(userID, firstName, lastName, clientType, licensePlate);
        } else if (clientType.equalsIgnoreCase("FACULTY")) {
            return new FacultyMember(userID, firstName, lastName, clientType, licensePlate);
        } else if (clientType.equalsIgnoreCase("VISITOR")) {
            return new Visitor(userID, firstName, lastName, clientType, licensePlate);
        } else {
